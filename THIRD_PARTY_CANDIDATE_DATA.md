...
On 2026-07-11, `tools/convert-chewing-candidates.ps1` read the pinned upstream CSV, removed metadata, pronunciation and one-scalar entries, split phrases into one-to-three-scalar prefixes with suffixes limited to three Unicode scalars, kept the maximum frequency for duplicates, then emitted deterministic frequency-ranked UTF-8 TSV.

- Candidate keys: `59,211`
- Candidate mappings: `202,639`
- Candidate size: `1,639,012` bytes
- Candidate SHA-256: `98DAB302D1CAA1504EA7240161C6F8BB5A7C97CB93B8C4314CD935CF77C77765`

Redistribution is permitted under LGPL-2.1-or-later provided that recipients keep this copyright, source, license and modification notice and receive the generated source-form data plus a copy of the LGPL. The generated source-form data is included as `candidate.txt`, the pinned upstream location is listed above, and the license text is included at `LICENSES/LGPL-2.1-or-later.txt`. This separate data license does not change the MIT license of the UCL_LIU_CSharp program code.
